...
struct StatisticsView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .sheet(isPresented: $showingWorkoutSheet) {
                 WorkoutSelectionView(workoutManager: workoutManager, locationManager: locationManager)
            }
            .fullScreenCover(item: $workoutManager.currentSession) { session in
                WorkoutView(workoutManager: workoutManager, locationManager: locationManager)
            }
        }
    }
    ...
    private var currentCalories: Int {
        switch selectedPeriod {
        case 0: return Int(locationManager.caloriesBurned)
        case 1: return Int(locationManager.caloriesBurned * 7)
        case 2: return Int(locationManager.caloriesBurned * 30)
        default: return Int(locationManager.caloriesBurned)
        }
    }
