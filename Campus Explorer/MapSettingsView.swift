...
class MapSettingsManager {
    ...
    private func saveSettings() {
        ...
        UserDefaults.standard.set(showFriendPaths, forKey: "showFriendPaths")
    ...
    private func loadSettings() {
        ...
        showFriendPaths = UserDefaults.standard.object(forKey: "showFriendPaths") as? Bool ?? true
...
struct MapSettingsView: View {
    ...
    @State private var showCustomLocationEntry = false
        ...
        NavigationView {
            Form {
                ...
                Section("Map Layers") {
                    ...
                    Toggle("Show Friend Paths", isOn: $mapSettings.showFriendPaths)
